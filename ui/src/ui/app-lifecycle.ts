...
export function handleConnected(host: LifecycleHost) {
  ...
  // IMPORTANT: apply URL overrides (gatewayUrl/token/session) BEFORE routing logic.
  // Otherwise a redirect from / → /chat can drop query params before they are persisted.
  applySettingsFromUrl(
